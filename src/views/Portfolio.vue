<template>
  <Page classes="portfolio-page" text="Portfolio" icon="fa-duotone fa-folders">
    <div v-for="(item, i) in portfolio" :key="`${i}-portfolio-item`">
      <img v-bind:src="item.previewImage" v-bind:alt="item.previewAlt" />
    </div>
  </Page>
</template>
